...
maxMaybe Nothing x'@(Just x) = x'
maxMaybe x'@(Just x) Nothing = x'
...
biggestTriangle (Primitive triang@(Triangle _ _)) = Just $ area triang
...
biggestTriangle (Rotate _ picture) = biggestTriangle picture
biggestTriangle (Translate _ _ picture) = biggestTriangle picture
